...
<< fig=false , include=FALSE , eps=FALSE , eval=FALSE >>= 
...
\begin{figure}[ht!]
\begin{center}
<< fig=TRUE , echo=FALSE , height=5, eval=FALSE >>=
...
\begin{figure}[ht]
\centering
<<fig=TRUE , include=TRUE, echo=FALSE , eps=FALSE , height=5, eval=FALSE>>=
plot( wbc, legend="topleft", inset=0.08)
@
...
<< label=fibroidfig, include=FALSE , fig=TRUE , eps=FALSE , echo=TRUE, height=5 , eval=FALSE>>= 
theta <- fib$theta
...
\begin{figure}[ht]
\centering
<< fig=TRUE, eps=FALSE, echo=FALSE, height=5, eval=FALSE >>=
<<fibroidfig>>
@
